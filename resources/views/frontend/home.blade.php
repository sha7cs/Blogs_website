        ...
        <div class="card border-light-subtle">
          <div class="row g-0">
            ...
            <div class="col-12 col-md-6 d-flex">
              <img class="img-fluid rounded-end object-fit-cover" loading="lazy" src="https://cdn.dribbble.com/users/633193/screenshots/16927736/media/2c3a8065f76c9ec7b34f14ff68b52d37.jpg" alt="Entrepreneurship">
            </div>
          </div>
        </div>
      </article>
          ...
          <div class="card border-0 bg-transparent mt-3">
            <figure class="card-img-top mb-4 overflow-hidden bsb-overlay-hover">
              <a href="/front-end/blog/{{ $blog->id }}">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="{{ asset('storage/'.$blog->image) }}" alt="{{ $blog->title }}" style="height: 300px; width:300px; object-fit: cover;">
              </a>
              <figcaption>
            ...
            <div class="card-body m-0 p-0">
              <div class="entry-header mb-3">
                ...
                <h2 class="card-title entry-title h4 m-0">
                  <a class="link-dark text-decoration-none" href="/front-end/show/{{ $blog->id }}">{{ $blog->title }}</a>
                </h2>
              </div>
            </div>
              ...
              <ul class="entry-meta list-unstyled d-flex align-items-center m-0">
                <li>
                  <a class="fs-7 link-secondary text-decoration-none d-flex align-items-center" href="#!">
                    ...
                    <span class="ms-2 fs-7">{{ $blog->created_at->format('d M Y') }}</span>
                  </a>
                </li>
                <li>
                  <span class="px-3">&bull;</span>
      ...
      <div class="container">
        <div class="row">
          <div class="col text-center">
            <a href="/blogs" class="btn bsb-btn-2xl btn-primary rounded-pill mt-5 mt-xl-10">All Articles</a>
          </div>
        </div>
      </div>
    </section>
