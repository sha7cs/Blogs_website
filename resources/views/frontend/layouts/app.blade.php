...
<head>
  ...
  <!-- CSS Files -->
  <link rel="stylesheet" href={{asset('frontend/css/planet-bsb.css')}}>
    ...
    <nav class="navbar navbar-expand-lg bsb-navbar bsb-navbar-hover bsb-navbar-caret bsb-tpl-navbar-sticky bg-white border-bottom border-light-subtle" data-bsb-sticky-target="#header">
      <div class="container">
        <a class="navbar-brand">
          <img src="frontend/img/branding/planet-logo.svg" class="bsb-tpl-logo" alt="">
        </a>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1">
              ...
              <li class="nav-item">
                <a class="nav-link {{ request()->is('front-end/blogs*') ? 'active' : '' }}" href={{asset('/front-end/blogs')}}>Blogs</a>
              </li>

              @if (Auth::check())
              <li class="nav-item">
                     <a class="nav-link  {{ request()->is('front-end/addblog*') ? 'active' : '' }}" href={{asset('/front-end/addblog')}}>Add Blog</a>
                 </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#!" id="blogDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">User</a>
                <ul class="dropdown-menu border-0 shadow bsb-zoomIn" aria-labelledby="blogDropdown">
                  <li><a class="dropdown-item  {{ request()->is('front-end/myblogs*') ? 'active' : '' }}" href="{{ route('front-end.myblogs.show', auth()->user()->id) }}">my blogs</a></li>
                  <li><a class="dropdown-item {{ request()->is('front-end/profile*') ? 'active' : '' }}" href="{{ route('front-end.profile', auth()->user()->id)}}">profile</a></li>

                  <li>
                  <form action="/logout" method="POST" class="dropdown-item">
                @csrf
                <button type="submit" class="btn btn-link p-0 m-0 align-baseline" style="color: inherit; text-decoration: none;" >logout</button>
                </form>
                </li>
                </ul>
              </li>
        ...
        <div class="row gy-3 gy-md-5 gy-xl-0 align-items-sm-center">
          <div class="col-xs-12 col-sm-6 col-xl-3 order-0 order-xl-0">
            <div class="footer-logo-wrapper text-center text-sm-start">
              <a href="#!">
                <img src="frontend/img/branding/planet-logo.svg" alt="" class="bsb-tpl-logo-footer">
              </a>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-xl-6 order-2 order-xl-1">
            <ul class="nav justify-content-center">
              ...
              <li class="nav-item">
                <a class="nav-link link-secondary px-2 px-md-3" href="/contact">Contact</a>
              </li>
              <li class="nav-item">
